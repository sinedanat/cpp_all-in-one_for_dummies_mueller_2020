#ifndef CAR_PARTS_HPP_INCLUDED
#define CAR_PARTS_HPP_INCLUDED

#include "bk03_mediator.hpp"
...
protected:
    ...
    int ChangedBy;
public:
    Electric(Mediator* med)
        : CarPart(med), Output(0), ChangedBy(0) {}
...
protected:
    ...
    int Brightness;
public:
    Headlights(Mediator* med)
        : CarPart(med), Brightness(0) {}
    void TurnOn()
    {
        Brightness = 100;
    }
...
protected:
    ...
    int ChangedBy;
public:
    AirConditioner(Mediator* med)
        : CarPart(med), Level(0), ChangedBy(0) {}
    void TurnOn();
    void TurnOff();
    bool GetLevel()
    {
